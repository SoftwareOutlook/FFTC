...
void passf2(int ido, int l1, const Treal cc[], Treal ch[], const Treal wa1[], int isign)
...
void passf3(int ido, int l1, const Treal cc[], Treal ch[],
...
void passf4(int ido, int l1, const Treal cc[], Treal ch[],
...
void passf5(int ido, int l1, const Treal cc[], Treal ch[],
...
void passf(int *nac, int ido, int ip, int l1, int idl1,
      Treal cc[], Treal ch[],
